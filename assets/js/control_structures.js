...
else console.log('You are an older adult');

// AND (&&) and OR (||) operators.
const isAdult = true;
const hasDriverLicense = false;

if (isAdult && hasDriverLicense) console.log('You can drive');
else if (isAdult || hasDriverLicense) console.log('You are close to driving');
